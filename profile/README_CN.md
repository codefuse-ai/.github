...
由此产生的模型集合包括[CodeFuse-13B](https://huggingface.co/codefuse/CodeFuse-13B)([魔塔仓库](https://modelscope.cn/models/ss41979310/CodeFuse-13B/files))和[CodeFuse-CodeLlama-34B](https://huggingface.co/codefuse/CodeFuse-CodeLlama-34B)([魔塔仓库](https://modelscope.cn/models/ss41979310/CodeFuse-CodeLlama-34B/files))，支持多种与代码相关的任务，如代码补全、文本转代码、单元测试生成等。值得一提的是，[CodeFuse-CodeLlama-34B](https://huggingface.co/codefuse/CodeFuse-CodeLlama-34B)基于CodeLlama作为基础模型，并利用我们提出的MFT框架进行微调，在HumanEval Python pass@1评估中取得高达的**74.4%（贪婪解码）**的好成绩，甚至**超过了GPT-4（67%）的表现**。我们计划在不久的将来将更多的基础LLMs纳入到我们的模型集合中。
